/* Zepto 1.1.7 - zepto event ajax form ie detect fx fx_methods assets data deferred callbacks selector touch gesture stack - zeptojs.com/license */
var Zepto = function() {
	function M(t) {
	...
	function L(t) {
		return _(t) && !D(t) && Object.getPrototypeOf(t) == Object.prototype
	}

	function $(t) {
		var e = !!t && "length" in t && t.length,
			i = n.type(t);
		return "function" != i && !D(t) && ("array" == i || 0 === e || "number" == typeof e && e > 0 && e - 1 in t)
	}
	...
	function V(n, i, r) {
		for (e in i) r && (L(i[e]) || N(i[e])) ? (L(i[e]) && !L(n[e]) && (n[e] = {}), N(i[e]) && !N(n[e]) && (n[e] = []), V(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
	}
	...
	return j.matches = function(t, e) {
		...
		var n, i = "#" == e[0],
			...
			a = i || r ? e.slice(1) : e,
			s = T.test(a);
		return Z(t) && s && i ? (n = t.getElementById(a)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : o.call(s && !i ? r ? t.getElementsByClassName(a) : t.getElementsByTagName(e) : t.querySelectorAll(e))
		...
		for (; e && (e = e.parentNode);)
			if (e === t) return !0;
		return !1
	}, n.type = M, n.isFunction = k, n.isWindow = D, n.isArray = N, n.isPlainObject = L, n.isEmptyObject = function(t) {
		var e;
		for (e in t) return !1;
		return !0
		...
		closest: function(t, e) {
			...
			return this.each(function(n, o) {
				for (; o && !(r ? r.indexOf(o) >= 0 : j.matches(o, t));) o = o !== e && !Z(o) && o.parentNode;
		...
		html: function(t) {
			return 0 in arguments ? this.each(function(e) {
				...
				n(this).empty().append(H(this, t, e, i))
		...
		attr: function(n, i) {
			...
			return "string" != typeof n || 1 in arguments ? this.each(function(t) {
				if (1 === this.nodeType)
					if (_(n))
						for (e in n) U(this, e, n[e]);
					else U(this, n, H(this, i, t, this.getAttribute(n)))
		...
		offset: function(t) {
			...
			if (s.documentElement !== this[0] && !n.contains(s.documentElement, this[0])) return {
				top: 0,
				left: 0
			};
		...
		css: function(t, i) {
			if (arguments.length < 2) {
				...
				if (N(t)) {
					...
					return n.each(t, function(t, e) {
						o[e] = r.style[C(e)] || a.getPropertyValue(e)
					}), o
				}
			}
			var s = "";
			if ("string" == M(t)) i || 0 === i ? s = z(t) + ":" + I(t, i) : this.each(function() {
				...
				for (e in t) t[e] || 0 === t[e] ? s += z(e) + ":" + I(e, t[e]) + ";" : this.each(function() {
		...
		addClass: function(t) {
			return t ? this.each(function(e) {
				if ("className" in this) {
					...
					}, this), i.length && Y(this, r + (r ? " " : "") + i.join(" "))
				}
			}) : this
		},
		removeClass: function(e) {
			return this.each(function(n) {
				if ("className" in this) {
					...
					i = Y(this), H(this, e, n, i).split(/\s+/g).forEach(function(t) {
						i = i.replace(q(t), " ")
					}), Y(this, i.trim())
				}
			})
		...
		n.fn[e] = function(r) {
			...
			return r === t ? D(a) ? a["inner" + i] : Z(a) ? a.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function(t) {
				a = n(this), a.css(e, H(this, r, t, a[e]()))
			})
		}
	}), v.forEach(function(e, i) {
		var r = i % 2;
		n.fn[e] = function() {
			var e, a, o = n.map(arguments, function(i) {
					var r = [];
					return e = M(i), "array" == e ? (i.forEach(function(e) {
						return e.nodeType !== t ? r.push(e) : n.zepto.isZ(e) ? r = r.concat(e.get()) : void(r = r.concat(j.fragment(e)))
					}), r) : "object" == e || null == i ? i : j.fragment(i)
				}),
				u = this.length > 1;
			return o.length < 1 ? this : this.each(function(t, e) {
				a = r ? e : e.parentNode, e = 0 == i ? e.nextSibling : 1 == i ? e.firstChild : 2 == i ? e : null;
				var f = n.contains(s.documentElement, a);
				o.forEach(function(t) {
					if (u) t = t.cloneNode(!0);
					else if (!a) return n(t).remove();
					a.insertBefore(t, e), f && J(t, function(t) {
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function(t) {
		...
		function E(e, i) {
			...
			}), e.timeStamp || (e.timeStamp = Date.now()), (i.defaultPrevented !== n ? i.defaultPrevented : "returnValue" in i ? i.returnValue === !1 : i.getPreventDefault && i.getPreventDefault()) && (e.isDefaultPrevented = b)), e
		}
	...
	function(t) {
		...
		function E(e) {
			e.processData && e.data && "string" != t.type(e.data) && (e.data = t.param(e.data, e.traditional)), !e.data || e.type && "GET" != e.type.toUpperCase() && "jsonp" != e.dataType || (e.url = T(e.url, e.data), e.data = void 0)
		}
		...
		l.href = window.location.href, t.active = 0, t.ajaxJSONP = function(i, r) {
			...
			if (a && a.promise(j), o.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", p || "*/*"), (p = o.mimeType || p) && (p.indexOf(",") > -1 && (p = p.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(p)), (o.contentType || o.contentType !== !1 && o.data && "GET" != o.type.toUpperCase()) && b("Content-Type", o.contentType || "application/x-www-form-urlencoded"), o.headers)
				for (r in o.headers) b(r, o.headers[r]);
			if (j.setRequestHeader = b, j.onreadystatechange = function() {
					if (4 == j.readyState) {
						j.onreadystatechange = w, clearTimeout(O);
						var e, n = !1;
						if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == S) {
							if (f = f || x(o.mimeType || j.getResponseHeader("content-type")), "arraybuffer" == j.responseType || "blob" == j.responseType) e = j.response;
							else {
								e = j.responseText;
								try {
								...
								if (n) return y(n, "parsererror", j, o, a)
							}
							v(e, j, o, a)
						} else y(j.statusText || null, j.status ? "error" : "abort", j, o, a)
					}
				}, g(j, o) === !1) return j.abort(), y(null, "abort", j, o, a), j;
			var P = "async" in o ? o.async : !0;
			if (j.open(o.type, o.url, P, o.username, o.password), o.xhrFields)
				for (r in o.xhrFields) j[r] = o.xhrFields[r];
			for (r in m) C.apply(j, m[r]);
			return o.timeout > 0 && (O = setTimeout(function() {
				j.onreadystatechange = w, j.abort(), y(null, "timeout", j, o, a)
	...
	function(t, e) {
		...
		o.style.transform === e && t.each(r, function(t, r) {
		...
		}), s = n + "transform", g[u = n + "transition-property"] = g[f = n + "transition-duration"] = g[l = n + "transition-delay"] = g[c = n + "transition-timing-function"] = g[h = n + "animation-name"] = g[p = n + "animation-duration"] = g[m = n + "animation-delay"] = g[d = n + "animation-timing-function"] = "", t.fx = {
			...
			var b, x, S, w = {},
				...
				C = !1;
			if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n) w[h] = n, w[p] = i + "s", w[m] = y + "s", w[d] = r || "linear", j = t.fx.animationEnd;
			else {
				x = [];
				for (b in n) a.test(b) ? T += b + "(" + n[b] + ") " : (w[b] = n[b], x.push(v(b)));
				T && (w[s] = T, x.push(s)), i > 0 && "object" == typeof n && (w[u] = x.join(", "), w[f] = i + "s", w[l] = y + "s", w[c] = r || "linear")
			}
			return S = function(e) {
	...
	function(t) {
		...
		t.when = function(i) {
			...
			if (o > 1)
				for (f = new Array(o), c = new Array(o), l = new Array(o); o > a; ++a) r[a] && t.isFunction(r[a].promise) ? r[a].promise().done(h(a, l, r)).fail(u.reject).progress(h(a, c, f)) : --s;
		...
		t(document).ready(function() {
			...
			"MSGesture" in window && (s = new MSGesture, s.target = document.body), t(document).bind("MSGestureEnd", function(t) {
				...
				(!(b = p(o, "up")) || h(o)) && (c(), e.x2 && Math.abs(e.x1 - e.x2) > 30 || e.y2 && Math.abs(e.y1 - e.y2) > 30 ? r = setTimeout(function() {
					e.el && (e.el.trigger("swipe"), e.el.trigger("swipe" + u(e.x1, e.x2, e.y1, e.y2))), e = {}
